...
class DetectLabelCommand extends Command
{
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOF
The <info>%command.name%</info> command detects labels in an image using the 
Google Cloud Vision API.
...
EOF
     ...
     */
    protected function detectLanguage($apiKey, $path)
    {
        ...
        var_dump($result->info()['labelAnnotations']);
    }
    // [END translate_detect_language]
}
